            ...
            <ExpansionPanelDetails className="panel-body">
                <div className="options-container">
                    ...
                    <div className="panel-actions">
                        <Button variant="contained" color="secondary" aria-label="Add option" onClick={props.addOption(question)}>
                            <AddIcon />
                            Add option
                        </Button>

                        <Button variant="contained" color="secondary" aria-label="Delete question" onClick={props.deleteQuestion(question)}>
                            <DeleteIcon />
                            Delete question
                        </Button>
                    </div>
